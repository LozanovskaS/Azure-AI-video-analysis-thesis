...
from backend.models import db, Match, ProcessingStatus
from backend.services.youtube_service import get_transcript, extract_video_id, get_video_ids_from_playlist, get_video_title
from backend.services.openai_service import clean_transcript_with_llm
...
def create_or_update_match(video_id, title=None, user_id=None):
